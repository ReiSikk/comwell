         ...
         <div className={styles.widget_inner}>
          ...
          <div className={styles.inner_lower}>
            <div className={styles.inputs_container}>
             <WidgetInput updateOverlayState={updateOverlayState} overlayState={overlayState} overlayToShow={"hotelOverlay"} inputText={"Choose hotel"} />
             <WidgetInput updateOverlayState={updateOverlayState} overlayState={overlayState} overlayToShow={"roomsOverlay"} inputText={"Choose room"} />
             <WidgetInput updateOverlayState={updateOverlayState} overlayState={overlayState} overlayToShow={"roomsOverlay"} inputText={"Check in / Check out"} />
            </div>
